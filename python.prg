...
PROCEDURE start_python(PythonHomeArg, PythonDllArg, PythonExecutable)
   ...
   IF Py_IsInitialized() == 0
      ...
      PUBLIC PyStrType, PyBytesType, PyBoolType, PyIntType, PyNotLongType, PyFloatType, PyDatetimeType, PyDateType
...
PROCEDURE stop_python
   ...
   RELEASE PyStrType, PyBytesType, PyBoolType, PyIntType, PyFloatType, PyDatetimeType, PyDateType, PyMajorVersion
   Local IsInitialized
